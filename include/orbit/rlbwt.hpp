...
inline interval_encoding_impl<> rlbwt_to_phi_inv(const std::vector<uchar>& bwt_heads, const std::vector<ulint>& bwt_run_lengths, const split_params& sp = split_params{}) {
    size_t domain;
    ulint max_length;
